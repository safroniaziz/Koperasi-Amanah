...
@section('location2')
    <i class="fa fa-dashboard"></i>&nbsp;MANAJEMEN SLIDER
@endsection
...
@section('content')
    <div class="callout callout-info ">
        <h4>Perhatian!</h4>
        <p>
            Berikut adalah data slider yang sudah ditambahkan, silahkan tambahkan jika ada data slider baru
            <br>
        </p>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-sliders"></i>&nbsp;Manajemen Gambar Slider</h3>
                    <div class="box-tools pull-right">
                        ...
                        <div class="modal fade" id="modaltambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-sliders"></i>&nbsp;Tambah Data Tentor Baru
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </h5>
                                </div>
                                <form action=" {{ route('operator.slider.add') }} " method="POST" enctype="multipart/form-data">
                            ...
                            @foreach ($sliders as $slider)
                                <tr>
                                            ...
                                            <div class="modal-dialog" role="document">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form method="POST" action="{{ route('operator.slider.delete') }}">
                                                        {{ csrf_field() }}
                                                        {{ method_field('DELETE') }}
                                    ...
                                    <div class="modal fade" id="modalubah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-sliders"></i>&nbsp;Ubah Data Slider
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </h5>
                                            </div>
                                            <form action=" {{ route('operator.slider.update') }} " method="POST" enctype="multipart/form-data">
                                                {{ csrf_field() }} {{ method_field('PATCH') }}
                                                            <div class="modal-body">
                                                                <input type="hidden" name="id" id="id">
                                                                <div class="form-group">
                                                                    <label for="exampleInputEmail1">Masukan Judul</label>
                                                                    <input type="text" name="title" id="title" class="form-control" placeholder="masukan judul" required>
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="exampleInputEmail1">Masukan Slogan</label>
                                                                    <textarea name="slogan" id="slogan" cols="30" rows="3" class="form-control"></textarea>
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="exampleInputEmail1">Gambar Slider </label>
                                                                    <input type="file" name="gambar" onchange="previewFoto2()" class="form-control">
                                                                </div>
                                                            </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-close"></i>&nbsp;Batalkan</button>
...
@push('scripts')
    <script>
        ...
        function ubahSlider(id){
            $.ajax({
                url: "{{ url('operator/manajemen_slider') }}"+'/'+ id + "/edit",
                type: "GET",
                dataType: "JSON",
