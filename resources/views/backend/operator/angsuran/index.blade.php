            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="{{ route('operator.transaksi_angsuran.add') }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i>&nbsp; Tambah Baru</a>
                    </div>
                </div>
                <!-- /.box-header -->
                        ...
                        <tbody>
                            ...
                            @foreach ($angsurans as $angsuran)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('operator.transaksi_angsuran.edit',[$angsuran->transaksi_id]) }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i>&nbsp;</a>
                                        <form action="{{ route('operator.transaksi_angsuran.delete',[$angsuran->transaksi_id]) }}" method="POST">
