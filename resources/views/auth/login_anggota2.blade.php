...
<html>
	<head>
		<meta charset="utf-8">
        <title>Koperasi Amanah Sejati | Login Anggota</title>
	...
	<body style="background-image:linear-gradient( rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7) ), url('{{ asset("assets/login/images/background.png") }}')">
		<div id="particles-js">
            <div class="loginBox">
                <img src=" {{ asset('assets/images/koperasi.png') }} " class="user">
                @if ($message = Session::get('error'))
                    ...
                    @else
                    <h6>Login Anggota</h6>
                    <p style="text-align:center; margin-bottom:20px;">Sistem Informasi Manajemen Koperasi Amanah Sejati</p>
                @endif
