            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="pull-right">
                        <a href="{{ route('operator.laporan.persentase_generate') }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-refresh fa-spin"></i>&nbsp;Generate Persentase SHU Tahun {{ $year }}</a>
                    </div>
                </div>
                <!-- /.box-header -->
